...
namespace Blog.Core.Common.Helper
{
    ...
    public static class ExpressionExtensions
    {
        ...
        public static async Task<string> Cof_NaocsGet(this Nacos.V2.INacosNamingService serv, string ServiceName, string Group, string apiurl, Dictionary<string, string> Parameters = null)
        {
            try
            {
